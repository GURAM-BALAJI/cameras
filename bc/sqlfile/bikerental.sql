...
INSERT INTO `tblbooking` (`id`, `userEmail`, `cameraId`, `FromDate`, `ToDate`, `message`, `Status`, `PostingDate`) VALUES
...
INSERT INTO `cameras` (`id`, `CameraTitle`, `CameraBrand`, `CameraOverview`, `PricePerDay`, `NBattery`, `ModelYear`, `Lens`, `Vimage1`, `Vimage2`, `Vimage3`, `Vimage4`, `Vimage5`, `CameraBag`, `SDCard`, `SmallLens`, `BigLens`, `Battery`, `ChargingWire`, `OTGC`, `OTGMicro`, `CDPlayer`, `CentralLocking`, `CrashSensor`, `LeatherSeats`, `RegDate`, `UpdationDate`) VALUES
