...
$sql="update cameras set Vimage5=:vimage where id=:id";
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">camera Image 5 </h2>

						<div class="row">
							<div class="col-md-10">
								<div class="panel panel-default" style="overflow-x:auto;">
									<div class="panel-heading">camera Image 5 Details</div>
...
<?php
$id=intval($_GET['imgid']);
$sql ="SELECT Vimage5 from cameras where cameras.id=:id";
$query = $dbh -> prepare($sql);
$query-> bindParam(':id', $id, PDO::PARAM_STR);
$query->execute();
