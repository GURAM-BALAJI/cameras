						...
						<div class="panel panel-default" style="overflow-x:auto;">
							...
							<?php if($error){?><div class="errorWrap"><strong>ERROR</strong>:<?php echo htmlentities($error); ?> </div><?php }
								...
								<table id="zctb" class="display table table-striped table-bordered table-hover" cellspacing="0" width="100%">
									...
									<?php $sql = "SELECT DISTINCT UserPhone from  tblbooking ";
...
$sql1 = "SELECT * from tblbooking WHERE UserPhone=:phone Limit 1";
		...
		?>
										<tr>
											...
											<td><?php echo htmlentities($result1->UserName);?></td>
											<td><?php echo htmlentities($result1->UserEmail);?></td>
											<td><?php echo htmlentities($result1->UserPhone);?></td>
