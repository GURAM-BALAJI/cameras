											...
											<div class="col-md-3">
                                    										<div class="panel panel-default">
                                    											<div class="panel-body bk-primary text-light">
                                    												...
                                    												<?php
                                    $sql6 ="SELECT id from tblbooking Where status=0";
...
<div class="col-md-3">
        										<div class="panel panel-default">
        											...
        											<div class="stat-panel text-center">
        <?php
        $sql2 ="SELECT id from tblbooking Where status=1";
        ...
        ?>
        													...
        													<div class="stat-panel-title text-uppercase">Total Sent</div>
        												</div>
        											</div>
        											<a href="manage-bookings.php" class="block-anchor panel-footer text-center">Full Detail &nbsp; <i class="fa fa-arrow-right"></i></a>
        										</div>
...
<div class="col-md-3">
                                    										<div class="panel panel-default">
                                    											<div class="panel-body bk-success text-light">
                                    												<div class="stat-panel text-center">
                                    												<?php
                                    $sql1 ="SELECT id from cameras where deletec=0";
                                    $query1 = $dbh -> prepare($sql1);;
                                    $query1->execute();
                                    $results1=$query1->fetchAll(PDO::FETCH_OBJ);
                                    $totalcamera=$query1->rowCount();
                                    ?>
                                    													<div class="stat-panel-number h1 "><?php echo htmlentities($totalcamera);?></div>
                                    													<div class="stat-panel-title text-uppercase">Listed Camera</div>
                                    												</div>
                                    											</div>
                                    											<a href="manage-Camera.php" class="block-anchor panel-footer text-center">Full Detail &nbsp; <i class="fa fa-arrow-right"></i></a>
                                    										</div>
                                    									</div>
									<div class="col-md-3">
										<div class="panel panel-default">
											<div class="panel-body bk-warning text-light">
												<div class="stat-panel text-center">
<?php
$sql3 ="SELECT id from tblbrands Where deleteb=0";
...
?>
			...
			<div class="col-md-3">
                                            										<div class="panel panel-default">
                                            											...
                                            											<div class="stat-panel text-center">
                                            <?php
                                            $sql2 ="SELECT DISTINCT UserPhone from  tblbooking ";
                                            $query2= $dbh -> prepare($sql2);
                                            $query2->execute();
                                            $results2=$query2->fetchAll(PDO::FETCH_OBJ);
                                            $bookings=$query2->rowCount();
