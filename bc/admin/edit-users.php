...
$post=$_POST['Post'];
$id=$_GET['id'];
$sql="UPDATE admin set UserName=:UserName,post=:post,camPhone=:camPhone,camEmail=:camEmail where id=:id";
...
<div class="col-sm-4">
<input type="text" name="Name" class="form-control" value="<?php echo htmlentities($result->UserName);?>">
</div>
<label class="col-sm-2 control-label">Phone<span style="color:red">*</span></label>
<div class="col-sm-4">
<input type="text" name="Phone" class="form-control" value="<?php echo htmlentities($result->camPhone);?>">
</div>
</div>
<div class="form-group">
<label class="col-sm-2 control-label">Email<span style="color:red">*</span></label>
<div class="col-sm-4">
<input type="text" name="Email" class="form-control" value="<?php echo htmlentities($result->camEmail);?>">
</div>
<label class="col-sm-2 control-label">Type Of User<span style="color:red">*</span></label>
<div class="col-sm-4">
<select class="selectpicker" name="Post" value="<?php echo htmlentities($result->post);?>">
