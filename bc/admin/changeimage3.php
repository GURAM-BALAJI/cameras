...
$sql="update cameras set Vimage3=:vimage where id=:id";
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">camera Image 3 </h2>

						<div class="row">
							<div class="col-md-10">
								<div class="panel panel-default" style="overflow-x:auto;">
									<div class="panel-heading">camera Image 3 Details</div>
...
<?php
$id=intval($_GET['imgid']);
$sql ="SELECT Vimage3 from cameras where cameras.id=:id";
$query = $dbh -> prepare($sql);
$query-> bindParam(':id', $id, PDO::PARAM_STR);
$query->execute();
...
<div class="col-sm-8">
<img src="img/cameraimages/<?php echo htmlentities($result->Vimage3);?>" width="300" height="200" style="border:solid 1px #000">
</div>
<?php }}?>
</div>
